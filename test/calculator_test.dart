...
void main() {
  ...
  group('Addition', () {
    test(
      ...
      double number2 = 3;
      // When
      double result = calculatorRepository.addition(number1, number2);
      // Then
  ...
  group('Multiplication', () {
    test(
        ...
        () {
      expect(calculatorRepository.multiplication(2, 3), equals(6));
      expect(calculatorRepository.multiplication(3, 2), equals(6));
    });
    ...
    test(
        ...
        () {
      expect(calculatorRepository.multiplication(0, 5), equals(0));
      expect(calculatorRepository.multiplication(5, 0), equals(0));
      expect(calculatorRepository.multiplication(0, 0), equals(0));
    });

    test(
        'Given Calculator class, when multiplication is called and there is a 1, then output same number multiplied to one',
        () {
      expect(calculatorRepository.multiplication(1, 5), equals(5));
      expect(calculatorRepository.multiplication(5, 1), equals(5));
      expect(calculatorRepository.multiplication(1, 1), equals(1));
    });
    ...
    test(
        ...
        () {
      expect(calculatorRepository.multiplication(2.5, 4), equals(10));
      expect(calculatorRepository.multiplication(4, 2.5), equals(10));
    });
  });
